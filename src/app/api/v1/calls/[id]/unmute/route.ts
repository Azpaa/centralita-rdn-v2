  ...
  try {
    ...
    if (!resolvedConference) {
      return apiBadRequest(
        'Conferencia no encontrada para la llamada. El unmute solo esta soportado para participantes en conferencia.',
        {
          call_sid: callSid,
    ...
    void auditLog('call.unmute', 'call_record', callSid, auth.userId, {
      call_sid: callSid,
